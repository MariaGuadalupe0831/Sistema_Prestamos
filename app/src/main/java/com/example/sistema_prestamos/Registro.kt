...
class Registro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl("http://192.168.156.147/Peliculas/api/") // URL base de tu API
        ...
        btnRegistrar.setOnClickListener {
            ...
            val contrasena = etPasswordRegistro.text.toString()
                ...
                if (response.isSuccessful) {
                    response.body()?.let { datos ->
                        if (datos[0].Estado == "true") {
                            ...
                            Toast.makeText(this@Registro, datos[0].Salida, Toast.LENGTH_SHORT)
                                .show()
                            finish()
                        } else {
                            Toast.makeText(this@Registro, datos[0].Salida, Toast.LENGTH_SHORT)
                        ...
                        Toast.makeText(
                            this@Registro,
                            "Respuesta vacía o en formato incorrecto",
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                } else {
                    ...
                    Toast.makeText(
                        this@Registro,
                        "Error en la respuesta del servidor: $errorBody",
                        Toast.LENGTH_LONG
                    ).show()
                }
            }
